...
const createWindow = (e) => {
  const window = `<div id ="popup" style="border: thick solid black;height: 310px;width: 800px;"><button type="button" class="closePopup" id="closePopup">x</button><form method="PUT" id="EditProductForm" name="addProductForm" action=""><h3>Edit Product</h3>
          <table><tr><td><label for="product_id"> ProductID:</label></td><td><input type="number" name="product_id" required readonly/>
...
const getAllProducts = async () => {
  ...
  table += `</table><script type="text/javascript">const elements = document.getElementsByClassName('edit'); 
