...
describe('Testing the SIGNUP endpoint', () => {
  ...
  describe('Testing the POST method', () => {
    ...
    // it('should check if request successful after token is set and unique email is passed', co.wrap((done) => {
    //   chai.request(app)
    //     .post('/api/v1/auth/signup')
    ...
    it('(POST / signup endpoint) should check that the name,email,admin property of body is filled', co.wrap(() => {
      chai.request(app)
        .post('/api/v1/auth/signup')
        .type('form')
        .send({
    ...
    it('(POST / signup endpoint) should check that the request is json', co.wrap(() => {
      chai.request(app)
        .post('/api/v1/auth/signup')
        .type('form')
        .send({
    ...
    // it('(POST / signup endpoint) should check that the response is json', (done) => {
    //   chai.request(app)
    //     .post('/api/v1/auth/signup')
    //     .type('form')
    //     .send({
